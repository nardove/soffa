...
function Designers() {
	return (
		<section id='designers' className='designers'>
			<h2 className='heading heading--dark heading--medium'>Meet The Designers</h2>
			<div className='designers__wrapper'>
				<div className='designer'>
					...
					<div className='designer__details'>
						<h3 className='heading heading--small heading--light shadow'>Rosa Kelly</h3>
						<p className='description description--light shadow'>
				...
				<div className='designer'>
					...
					<div className='designer__details'>
						<h3 className='heading heading--small heading--light shadow'>Duane Day</h3>
						<p className='description description--light shadow'>
